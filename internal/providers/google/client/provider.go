...
func GoogleDescriptor() providers.Provider {
	return providers.Provider{
		...
		Handlers: map[string]actions.Handler{
			...
			"google.sheets.create":                  handleSheetsCreate,
			"google.sheets.get":                     handleSheetsGet,
			"google.sheets.values.get":              handleSheetsValuesGet,
			"google.sheets.values.update":           handleSheetsValuesUpdate,
			"google.sheets.values.append":           handleSheetsValuesAppend,
			"google.sheets.values.clear":            handleSheetsValuesClear,
			"google.sheets.values.batch_update":     handleSheetsValuesBatchUpdate,
			"google.sheets.tabs.add":                handleSheetsTabsAdd,
			"google.sheets.tabs.delete":             handleSheetsTabsDelete,
			"google.sheets.tabs.rename":             handleSheetsTabsRename,
			"google.sheets.rows.insert":             handleSheetsRowsInsert,
			"google.sheets.rows.delete":             handleSheetsRowsDelete,
			"google.sheets.columns.insert":          handleSheetsColumnsInsert,
			"google.sheets.columns.delete":          handleSheetsColumnsDelete,
			"google.sheets.format_range":            handleSheetsFormatRange,
			"google.sheets.merge_cells":             handleSheetsMergeCells,
			"google.sheets.unmerge_cells":           handleSheetsUnmergeCells,
			"google.sheets.protected_ranges.add":    handleSheetsProtectedRangesAdd,
			"google.sheets.protected_ranges.delete": handleSheetsProtectedRangesDelete,
			"google.sheets.batch_update":            handleSheetsBatchUpdate,
		},
