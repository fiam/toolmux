...
3. Generic `supaclid` container images, for example GHCR images.
...
supaclid image      -> private AWS deployment
```

The public `supaclid` image is a generic HTTP server image. The private
